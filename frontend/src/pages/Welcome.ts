...
export default class WelcomePage extends Page {
  ...
  titleCard = new Div([
    ...
    new Paragraph("Pong. Delivered to your doorstep."), // TODO(Vaiva): Add memes
    this.playButton,
  ...
  bindEvents() {
    this.titleCard.byId()?.addEventListener('click',
      () => this.router.navigate("/play"));
    this.playButton.byId()?.addEventListener('click',
      () => this.router.navigate("/play"));
  }
}
