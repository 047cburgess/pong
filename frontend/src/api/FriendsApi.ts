...
import { IncomingMessage } from "../handlers/NotificationsHandlers.js";

export const friendsApi = {
	getFriends: (id?: user_id) => apiCall<PublicUserData[]>("GET", "/user/friends", id),
	getIncoming: (id?: user_id) => apiCall<PublicUserData[]>("GET", "/user/friends/requests", id),
	getOutgoing: (id?: user_id) => apiCall<PublicUserData[]>("GET", "/user/friends/requests/outgoing", id),
	getNotifications: (id?: user_id) => apiCall<IncomingMessage[]>("GET", "/user/friends/notifications", id),
